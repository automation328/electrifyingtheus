// Static default prose for the Reduced Emissions page. Kept here (not inline in
// the page) so BOTH the page and the CMS Pages editor can read the current copy
// — the editor pre-fills from these defaults, and EditableContentPage falls back
// to them when no override is published. Non-prose props (icon, hero image,
// gallery, video) stay in the page component.
...
export const reducedEmissionsContent = {
