...
export const eventsConfig: CollectionConfig = {
  ...
  fields: [
    ...
    { name: "register_url", label: "Registration link", type: "text", help: "Where both Register buttons on the event page send people. Leave blank and they go to Contact us instead." },
    { name: "register_label", label: "Register button text", type: "text", placeholder: "Register", width: "half", help: "The button beside the poster. Blank uses “Register”." },
