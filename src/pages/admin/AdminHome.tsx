...
const CARDS: Card[] = [
  ...
  { to: "/admin/content/vehicles", label: "Vehicles", icon: Car, desc: "Calculator catalog", soon: true },
  { to: "/admin/content/incentives", label: "Incentives", icon: BadgePercent, desc: "Rebates & credits", soon: true },
...
function useCounts() {
  return useQuery({
    ...
    queryFn: async () => {
      const tables: AdminTable[] = ["site_blog_posts", "site_events", "site_gallery", "site_jobs"];
