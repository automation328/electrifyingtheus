...
const ThemeEditor = () => {
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-bold font-display text-foreground mb-1">Theme colors</h1>
      <p className="text-sm text-muted-foreground mb-6">Your brand colors, applied across the whole site — buttons, links, highlights, and gradients.</p>
