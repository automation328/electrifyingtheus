...
const Calculator = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {!embed && <Navbar />}
      <div className={embed ? "pt-8 pb-12" : "pt-24 pb-16"}>
      ...
      {embed && (
        <div className="container px-4 max-w-6xl pb-8 text-center">
          <a href="https://electrifyingtheus.com/calculator" target="_blank" rel="noopener noreferrer"
